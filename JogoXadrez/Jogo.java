...
public class Jogo 
{
	...
	public void promover2(int nome, Peca peca, Casa o){
		//Promove o peão branco para rainha branca.
        if((peca.getTipo() == Peca.PEAO_BRANCO) && (nome == 0))
        {
            o.removerPeca();
            Peca pecaPromovida = new Rainha(o, Peca.RAINHA_BRANCA); 
        }
        //Promove o peão preto para rainha preta.
        if((peca.getTipo() == Peca.PEAO_PRETO)  && (nome == 0))
        {
            o.removerPeca();
            Peca pecaPromovida = new Rainha(o, Peca.RAINHA_PRETA); 
        }
        //Promove o peão branco para cavalo branco.
        if((peca.getTipo() == Peca.PEAO_BRANCO) && (nome == 1))
        {
            o.removerPeca();
            Peca pecaPromovida = new Cavalo(o, Peca.CAVALO_BRANCO); 
        }
        //Promove o peão preto para cavalo preto.
        if((peca.getTipo() == Peca.PEAO_PRETO)  && (nome == 1))
        {
            o.removerPeca();
            Peca pecaPromovida = new Cavalo(o, Peca.CAVALO_PRETO); 
        }
        //Promove o peão branco para torre branca.
        if((peca.getTipo() == Peca.PEAO_BRANCO) && (nome == 2))
        {
            o.removerPeca();
            Peca pecaPromovida = new Torre(o, Peca.TORRE_BRANCA); 
        }
        //Promove o peão preto para torre preta.
        if((peca.getTipo() == Peca.PEAO_PRETO)  && (nome == 2))
        {
            o.removerPeca();
            Peca pecaPromovida = new Torre(o, Peca.TORRE_PRETA); 
        }
        //Promove o peão branco para bispo branco.
        if((peca.getTipo() == Peca.PEAO_BRANCO) && (nome == 3))
        {
            o.removerPeca();
            Peca pecaPromovida = new Bispo(o, Peca.BISPO_BRANCO); 
        }
        //Promove o peão preto para bispo preto.
        if((peca.getTipo() == Peca.PEAO_PRETO)  && (nome == 3))
        {
            o.removerPeca();
            Peca pecaPromovida = new Bispo(o, Peca.BISPO_PRETO); 
        }
	}
